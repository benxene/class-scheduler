...
export declare class Schedule {
    ...
    private YET_TO_MSG;
    constructor(calendar: Calendar, { noScheduleMessage, breakMessage, classesOverMessage, yetToBeginMessage }?: {
     ...
     */
    getCurrentClass({ useMeaningfulMessage }?: {
        useMeaningfulMessage: boolean;
    }): string;
    /**
     * Get the next upcoming class.
     */
    getNextClass({ allowNextDay }?: {
        allowNextDay: boolean;
    }): string;
    /**
     * Get the class coming after the next class.
     */
    getLaterClass({ allowNextDay }?: {
        allowNextDay: boolean;
    }): string;
}
